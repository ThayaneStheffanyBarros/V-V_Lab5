describe("product reviews", () => {
  ...
  it("test case 4: Ordenar avaliações de produto pelo título ao clicar no cabeçalho", () => {
  ...
  it("test case 6: Filtrar avaliações de produto que não contêm uma palavra-chave específica", () => {
